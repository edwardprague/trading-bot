...
def run_backtest(df):
    ...
    for i in range(1, len(df)):
        ...
        if not in_trade:
            ...
            if (i >= 4 and last_low_label == 'L' and last_high_label == 'H'
            ...
            if (i >= 4 and last_high_label == 'H' and last_low_label == 'L'
