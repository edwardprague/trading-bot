...
(function () {
  ...
  /* ── Keyboard shortcut: S — Toggle Backtest Settings ────────
     May 2026: changed from "B" to "S" so the same key opens the
     equivalent settings panel on the BD, Regimes, and Discovery
     pages — a single muscle-memory shortcut across the platform. */
  document.addEventListener("keydown", function (e) {
