  ...
  function buildRunMarkdown(ver, run) {
    ...
    if (pvd && pvd.is_single_day) {
      ...
      if (pvList.length === 0) {
        ...
        lines.push("| # | Type 2 | VD High | VD Low | H6 | Height | L# | Pullback % | Width | Price | Time | ATR (pips) | ADX | Horiz Distance (bars) |");
        lines.push("|---|--------|---------|--------|-----|--------|----|-----------|----- -|-------|------|------------|-----|-----------------------|");
        var mdBarOutcome = {};
        ...
        pvList.forEach(function (pv, idx) {
          ...
          if (mdOc) mdNum += " " + mdOc;
          lines.push("| " + mdNum + " | " + (mdType2 || "") + " | " + mdVertHigh + " | " + mdVertLow + " | " + mdH6 + " | " + mdHeight + " | " + mdLhNum + " | " + pullbackD + " | " + mdWidth + " | " +
