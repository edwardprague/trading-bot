  ...
  function buildRunMarkdown(ver, run) {
    ...
    if (pvd && pvd.is_single_day) {
      ...
      if (pvList.length === 0) {
        ...
        lines.push("| Time | # | Type | L# | VD High | VD Low | H6 | H3 | H1 | ATR (pips) | ADX | Pullback % | Width | Price |");
        lines.push("|------|---|------|----|---------|--------|-----|-----|-----|------------|-----|-----------|----- -|-------|");
        var mdBarOutcome = {};
        ...
        pvList.forEach(function (pv, idx) {
          ...
          if (mdOc) mdNum += " " + mdOc;
          lines.push("| " + (pv.time || "") + " | " + mdNum + " | " + (mdType2 || "") + " | " + mdLhNum + " | " + mdVertHigh + " | " + mdVertLow + " | " + mdH6 + " | " + mdH3 + " | " + mdHeight + " | " + atrD + " | " + adxD + " | " + pullbackD + " | " + mdWidth + " | " +
            mf(pv.price, 5) + " |");
        });
      }
      lines.push("");
